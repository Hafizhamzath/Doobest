        ...
        <div>
          ...
          <ul className="flex flex-col gap-3.5 text-[13.5px] text-white/70">
            ...
            <li className="flex items-center gap-1.5">
              ...
              />
              <PhoneChoice
                label={`${siteConfig.phone.sriLanka} (Sri Lanka)`}
                tel="+94740410943"
                wa="https://wa.me/94740410943"
                triggerClassName="text-white/70 transition-colors hover:text-white"
              />
            </li>
            <li className="flex items-center gap-1.5">
              <Icon
              ...
              />
              <PhoneChoice
                label={`${siteConfig.phone.uae} (UAE)`}
                tel="+971543748522"
                wa="https://wa.me/971543748522"
                triggerClassName="text-white/70 transition-colors hover:text-white"
              />
            </li>
