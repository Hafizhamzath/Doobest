        ...
        <div>
          ...
          <ul className="flex flex-col gap-3.5 text-[13.5px] text-white/70">
            ...
            <li className="flex items-center gap-2.5">
              ...
              />
              <span className="flex-1">{siteConfig.phone.sriLanka} (Sri Lanka)</span>
              <span className="flex shrink-0 items-center gap-1.5">
                <a
                  href="tel:+94740410943"
                  aria-label="Call Sri Lanka office"
                  className="flex h-6 w-6 items-center justify-center rounded-full bg-white/[0.06] text-white/70 transition-colors hover:bg-maroon hover:text-white"
                >
                ...
                <a
                  ...
                  className="flex h-6 w-6 items-center justify-center rounded-full bg-white/[0.06] text-[#25D366] transition-colors hover:bg-[#25D366] hover:text-white"
                >
            ...
            <li className="flex items-center gap-2.5">
              <Icon
                ...
                className="shrink-0 text-maroon"
              />
              <span className="flex-1">{siteConfig.phone.uae} (UAE)</span>
              <span className="flex shrink-0 items-center gap-1.5">
                <a
