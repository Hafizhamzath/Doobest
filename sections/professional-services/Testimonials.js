    ...
    <Container as="section" className="flex flex-wrap gap-10 pb-20 md:pb-24">
      ...
      <div className="grid flex-1 basis-[600px] grid-cols-1 gap-6 sm:grid-cols-3">
        {testimonials.map((testimonial, index) => (
          ...
          <div
            className="rounded-2xl border-l-[3px] border-transparent bg-white px-6 py-7 shadow-[0_14px_30px_rgba(17,17,17,0.06)] transition-all duration-300 hover:border-l-gold hover:shadow-[0_18px_36px_rgba(100,16,16,0.14)]"
          >
